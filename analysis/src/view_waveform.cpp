...
int main(int argc, char* argv[]) {
    ...
    // キャンバスのセットアップ (上下2画面)
    TCanvas* c = new TCanvas("c_wave", "Waveform Viewer", 800, 800);
    c->Divide(1, 2);
    ...
    string cmd;
    cout << "\n========================================================" << endl;
    cout << " Waveform Viewer Interactive Mode" << endl;
    ...
    while (true) {
        ...
        gSystem->ProcessEvents(); // X11ウィンドウの再描画などをフラッシュ
    }
